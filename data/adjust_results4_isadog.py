...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    # Read dog names from the file into a dictionary
    dognames_dic = {}
    ...
    for filename, labels in results_dic.items():
        ...
        if pet_label in dognames_dic:
            labels.append(1)  # Pet image label is a dog
        else:
            labels.append(0)  # Pet image label is not a dog
        ...
        if classifier_is_dog:
            labels.append(1)  # Classifier label is a dog
        else:
            labels.append(0)  # Classifier label is not a dog
