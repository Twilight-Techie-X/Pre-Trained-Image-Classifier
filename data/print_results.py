...
def print_results(results_dic, results_stats_dic, model, 
    ...
    print(f"Percentage of Correct 'Not-a' Dogs: {results_stats_dic['pct_correct_notdogs']:.2f}%")
    ...
    if print_incorrect_dogs:
        ...
        for key in results_dic:
            ...
            if pet_label_is_dog != classifier_label_is_dog:
    ...
    if print_incorrect_breed:
        ...
        for key in results_dic:
            ...
            if pet_label_is_dog and classifier_label_is_dog and not labels_match:
                print(f"Pet Image Label: {results_dic[key][0]}, Classifier Label: {results_dic[key][1]}")
